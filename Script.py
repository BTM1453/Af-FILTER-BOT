...
• /deletefiles - <code>Tᴏ ᴅᴇʟᴇᴛᴇ CᴀᴍRɪᴘ ᴀɴᴅ PʀᴇDVD Fɪʟᴇs ғʀᴏᴍ ᴛʜᴇ ʙᴏᴛ's ᴅᴀᴛᴀʙᴀsᴇ.</code>"""
    ...
    SEC_STATUS_TXT = """<b>★ 𝗧𝗼𝘁𝗮𝗹  𝗨𝘀𝗲𝗮𝗿𝘀: <code>{}</code>

 𝗧𝗼𝘁𝗮𝗹 𝗖𝗵𝗮𝘁𝘀 : <code>{}</code>

 𝗧𝗼𝘁𝗮𝗹 𝗙𝗶𝗹𝗲𝘀: <code>{}</code>

 𝗨𝘀𝗲 𝗦𝘁𝗼𝗿𝗮𝗴𝗲: <code>{} MB</code>

 𝗙𝗿𝗲𝗲 𝗦𝘁𝗼𝗿𝗮𝗴𝗲: <code>{} MB</code></b>"""
...
Aᴅᴅᴇᴅ Bʏ - {}"""
    ...
    LOG_TEXT_P = """#𝗙𝗶𝗹𝗲𝗦𝗲𝗮𝗿𝗰𝗵𝗫𝟭_𝗨𝘀𝗲𝗮𝗿𝘀
...
ᴅɪᴅ ʏᴏᴜ ᴍᴇᴀɴ ᴀɴʏ ᴏɴᴇ ᴏꜰ ᴛʜᴇꜱᴇ?"""
    ...
    I_CUDNT = """<b>𝗠𝗼𝘃𝗶𝗲 𝗡𝗼𝘁 𝗙𝗼𝘂𝗻𝗱 𝗗𝘂𝗱𝗲😔
𝗗𝗼 𝘀𝗲𝗮𝗿𝗰𝗵 𝗶𝗻 𝗴𝗼𝗼𝗴𝗹𝗲 𝗮𝗻𝗱 𝗰𝗼𝗽𝘆 𝘁𝗵𝗮𝘁 𝗻𝗮𝗺𝗲 𝗮𝗻𝗱 𝘀𝗲𝗻𝗱 𝗶𝗳 𝘁𝗵𝗮𝘁 𝗺𝗼𝘃𝗶𝗲𝘀 𝗢𝗧𝗧</b>"""
...
☞ <a href="https://t.me/+FHe4nVjjxrI1MDc9">𝙾ᴛᴛ ᴜᴩᴅᴀᴛᴇ 𝙲ʜᴀɴɴᴇʟ</a> 
☞ <a href="https://t.me/CINEMA_COMPANYE_Backup"> 𝙼ᴏᴠɪᴇ 𝚂ᴇᴀʀᴄʜ 𝙶ʀᴏᴜᴩ - 𝟷</a> 
☞ <a href="https://t.me/+MOrvSbM3zfVjNmRl"> 𝙼ᴏᴠɪᴇ 𝚂ᴇᴀʀᴄʜ 𝙶ʀᴏᴜᴩ - 𝟸</a> 
☞ <a href="https://t.me/TBM_Bot_Updates"> 𝙱ᴏᴛ 𝚄ᴩᴅᴀᴛᴇꜱ 𝙲ʜᴀɴɴᴇʟ</a>
