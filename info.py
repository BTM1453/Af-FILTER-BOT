...
API_ID = int(environ.get('API_ID', '24638343'))
API_HASH = environ.get('API_HASH', 'c16b13b73c2f2473b8e3cbcf2ab1d200')
BOT_TOKEN = environ.get('BOT_TOKEN', "")


# This Pictures Is For Start Message Picture, You Can Add Multiple By Giving One Space Between Each.
PICS = (environ.get('PICS', 'https://telegra.ph/file/35cee6476a82c69bfa353-efe9ff2cb1a72237f7.jpg https://telegra.ph/file/a786ebc8aa61db2f290bf-c0f7997778fb5bc0cd.jpg https://telegra.ph/file/a3ac8e0c68a70f1cddf2f-a2397f19cf92569694.jpg https://telegra.ph/file/4635953b483c6fd3a6270-cdf4d91950f0ca73bd.jpg https://telegra.ph/file/721753fa077628808d2e7-237d642792ef9491e6.jpg')).split()


# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6272165202').split()] # For Multiple Id Use One Space Between Each.
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002806870211'))

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002288998123').split()]  # For Multiple Id Use One Space Between Each.
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002661445312') # give your force subscribe channel id here else leave it blank
...
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '-1002618602500').split()]  # For Multiple Id Use One Space Between Each.


# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://msom70026:AFLAHMM555@cluster0.ekqbhbh.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/CINEMA_COMPANYE_Backup')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/TBM_Bot_Updates')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/TBM_Support_Group') # Support Chat Link Without https:// or @
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/TBM_Admin')
