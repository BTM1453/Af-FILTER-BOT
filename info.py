...
auth_channel = environ.get('AUTH_CHANNEL', '-1002476966921') # give your force subscribe channel id here else leave it blank
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://terrymcorwin64:p2a0qkEumeO9lvPV@cluster0.ibcwqai.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
